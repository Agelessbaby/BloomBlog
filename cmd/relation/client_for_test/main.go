...
func main() {
	client, err := relationsrv.NewClient("BloomBlogRelationServer", client.WithHostPorts("0.0.0.0:8087"))
	if err != nil {
		panic(err)
	}
	...
	//})
	resp, err := client.RelationAction(context.TODO(), &relation.BloomblogRelationActionRequest{
		UserId:     0,
		Token:      "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiIiLCJpc3MiOiJCbG9vbUJMb2ciLCJhdWQiOiIiLCJzdWIiOiIiLCJpYXQiOjE3MzEzMTExNzAsIm5iZiI6MCwiZXhwIjoxNzMyMDAyMzcwLCJ1ZCI6eyJ1c2VyaWQiOjN9fQ.2mwVT7xI46NS_dvTZZOvcslbQ4X6z82oMWh07UQ9_tY",
		ToUserId:   3,
		ActionType: 1,
